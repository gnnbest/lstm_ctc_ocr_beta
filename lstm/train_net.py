...
if __name__ == '__main__':
   ...
   #                'val_path':'/media/nas/ocr/OCR_samples/tfrecord/200+22_mix/val.tfrecords' })
    ...
    imgdb = edict({'path': '/home/gunn/real_lstm_ctc_ocr_beta/lib/utils/data/train.tfrecords',
                   'name': 'lstm_' + output_network_name,
                   'val_path':'/home/gunn/real_lstm_ctc_ocr_beta/lib/utils/data/val.tfrecords' })
